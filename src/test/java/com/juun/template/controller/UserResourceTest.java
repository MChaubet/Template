...
class UserResourceTest {
     ...
     */
    public static User initTestUser(UserDao userDao, EntityManager em) {
    ...
    void testUserDTOtoUser() {
        ...
        User user = UserMapper.INSTANCE.adminUserDTOToUser(userDTO);
    ...
    void testUserToUserDTO() {
        ...
        AdminUserDTO userDTO = UserMapper.INSTANCE.userToAdminUserDTO(user);
    ...
    private void assertPersistedUsers(Consumer<List<User>> userAssertion) {
        userAssertion.accept(userDao.findAll());
    }
}
