package com.juun.template.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.juun.template.IntegrationTest;
import com.juun.template.dao.timezone.DateTimeWrapper;
import com.juun.template.dao.timezone.DateTimeWrapperDao;
import java.time.*;
...
public class HibernateTimeZoneTest {
    ...
    @Autowired
    private DateTimeWrapperDao dateTimeWrapperDao;
    ...
    void storeInstantWithZoneIdConfigShouldBeStoredOnGMTTimeZone() {
        dateTimeWrapperDao.saveAndFlush(dateTimeWrapper);
