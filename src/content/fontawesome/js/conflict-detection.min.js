...
(e = function () {
    ...
    for (var e = 1; e < arguments.length; e++) {
      ...
      e % 2
        ? t(Object(r), !0).forEach(function (e) {
            ...
            (t = o),
              (e = r[(n = e)]),
              n in t ? Object.defineProperty(t, n, { value: e, enumerable: !0, configurable: !0, writable: !0 }) : (t[n] = e);
          })
  ...
  d &&
    ((p = (u.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(u.readyState)) || u.addEventListener('DOMContentLoaded', i));
  ...
  var y =
    ((function (e) {
      ...
      function c(e, t) {
        ...
        for (var c = 1732584193, a = -271733879, s = -1732584194, l = 271733878, f = 0; f < e.length; f += 16)
      ...
      function i(e, t) {
        return (function (e, t) {
          var n,
            ...
            r = [],
            i = [];
          for (r[15] = i[15] = void 0, 16 < o.length && (o = c(o, 8 * e.length)), n = 0; n < 16; n += 1)
  ...
  function b(e) {
    if (null !== e && 'object' === n(e))
      return e.src ? y(e.src) : e.href ? y(e.href) : e.innerText && '' !== e.innerText ? y(e.innerText) : void 0;
  }
  var v = 'fa-kits-diag',
            ...
            function (n, o, r) {
              parent.FontAwesomeDetection.__pollUntil({
                ...
                .catch(function (e) {
                  ...
                  'timeout' === e
                    ? parent.postMessage({ type: 'no-conflict', src: t.src, innerText: t.innerText, tagName: t.tagName, md5: o }, r)
                    : console.error(e);
                });
            }.toString(),
            ")('"
      ...
      e = (function () {
        var e = Array.from(u.getElementsByTagName('link')).filter(function (e) {
          ...
          t = Array.from(u.getElementsByTagName('style')).filter(function (e) {
            return (
              !e.hasAttribute(x) &&
              (!f.FontAwesomeConfig || !e.innerText.match(new RegExp('svg:not\\(:root\\)\\.'.concat(f.FontAwesomeConfig.replacementClass))))
            );
          });
        function n(e, t) {
    ...
    console.group('Font Awesome Detector'),
      0 === i
        ...
        : (console.info('Testing '.concat(i, ' possible conflicts.')),
          console.info(
            "We'll wait about ".concat(Math.round(f.FontAwesomeDetection.timeout / 10) / 100, ' seconds while testing these and\n') +
          ...
          console.info(
            '\t%c'.concat(T, "%c: milliseconds to wait for each test before deciding whether it's a conflict."),
            'font-weight: bold;',
            'font-size: normal;'
          ),
          console.info(
            '\t%c'.concat(D, '%c: milliseconds to wait for the browser to accumulate test results before giving up.'),
            'font-weight: bold;',
            'font-size: normal;'
          ),
          O({
            ...
            .then(function () {
              console.info('DONE!'), F({ nodesTested: n, nodesFound: r }), t({ nodesTested: n, nodesFound: r }), console.groupEnd();
            })
            .catch(function (e) {
              'timeout' === e
          ...
          {},
          {
            report: function (e) {
              ...
              if (0 < (e = Object.keys(n.noConflict).length)) {
                console.info(
                  '%cNo conflict'.concat(1 < e ? 's' : '', ' found with ').concat(1 === e ? 'this' : 'these', ':'),
              ...
              if (0 < (e = Object.keys(r).length)) {
                console.info(
                  '%cLeftovers--we timed out before collecting test results for '.concat(1 === e ? 'this' : 'these', ':'),
  ...
  []
    .concat(
      ...
      })((N = Object.keys({ solid: 'fas', regular: 'far', light: 'fal', thin: 'fat', duotone: 'fad', brands: 'fab', kit: 'fak' }))) ||
        (function (e) {
