...
!(function () {
  ...
  p &&
    ((ct = (h.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(h.readyState)) || h.addEventListener('DOMContentLoaded', rt));
  function mt(t, a, e, n) {
    for (
      var i, r, o = Object.keys(t), s = o.length, c = void 0 !== n ? dt(a, n) : a, f = void 0 === e ? ((i = 1), t[o[0]]) : ((i = 0), e);
      i < s;
      i++
    )
      f = c(f, t[(r = o[i])], r, t);
  ...
  function pt(t, a, e) {
    var n = (2 < arguments.length && void 0 !== e ? e : {}).skipHooks,
      e = void 0 !== n && n,
      n = vt(a);
    'function' != typeof ot.hooks.addPack || e ? (ot.styles[t] = k(k({}, ot.styles[t] || {}), n)) : ot.hooks.addPack(t, vt(a)),
      'fas' === t && pt('fa', a);
  }
  var gt = ot.styles,
    ht = ot.shims,
    ...
    _t = {
      ...
      parse: {
        icon: function (t) {
          ...
          if ('object' === n(t) && t.prefix && t.iconName) return { prefix: t.prefix, iconName: Et(t.prefix, t.iconName) || t.iconName };
  ...
  function qt(t) {
    ...
    d && (b.attributes[A] = ''),
      c &&
        (b.children.push({ tag: 'title', attributes: { id: b.attributes['aria-labelledby'] || 'title-'.concat(l || J()) }, children: [c] }),
      ...
      s
        ...
        : ((g = (p = t).children),
          ...
          at((p = p.transform)) &&
            ...
            (y = 0.5),
            (h.style = tt(k(k({}, t), {}, { 'transform-origin': ''.concat(v + p.x / 16, 'em ').concat(y + p.y / 16, 'em') })))),
  ...
  function Vt(t) {
    ...
    at(i) &&
      ((s.transform =
        ...
        (e +=
          c && y
            ? 'translate('.concat(o.x / V - (void 0 === i ? w : i) / 2, 'em, ').concat(o.y / V - n / 2, 'em) ')
            : c
            ? 'translate(calc(-50% + '.concat(o.x / V, 'em), calc(-50% + ').concat(o.y / V, 'em)) ')
            : 'translate('.concat(o.x / V, 'em, ').concat(o.y / V, 'em) ')),
        (e += 'scale('.concat((o.size / V) * (o.flipX ? -1 : 1), ', ').concat((o.size / V) * (o.flipY ? -1 : 1), ') ')),
    ...
    return {
      ...
      icon: Array.isArray(t)
        ? {
            ...
            children: [
              { tag: 'path', attributes: { class: ''.concat(X.familyPrefix, '-').concat(W.SECONDARY), fill: 'currentColor', d: t[0] } },
              { tag: 'path', attributes: { class: ''.concat(X.familyPrefix, '-').concat(W.PRIMARY), fill: 'currentColor', d: t[1] } },
            ],
          }
  ...
  function Qt(i, r) {
    ...
    return (
      ...
      new Promise(function (t, a) {
        ...
        if (('fa' === o && ((n = jt(i) || {}), (i = n.iconName || i), (r = n.prefix || r)), i && r && Gt[r] && Gt[r][i]))
          return t(Kt(Gt[r][i]));
        (e = i),
          (n = r),
          j || X.showMissingIcons || !e || console.error('Icon with name "'.concat(e, '" and prefix "').concat(n, '" is missing.')),
          t(k(k({}, Jt), {}, { icon: (X.showMissingIcons && i && Ht('missingIconAbstract')) || {} }));
      })
    );
  }
  function Zt() {}
  function $t(t) {
    ta.mark(''.concat(aa, ' ').concat(t, ' ends')),
      ta.measure(''.concat(aa, ' ').concat(t), ''.concat(aa, ' ').concat(t, ' begins'), ''.concat(aa, ' ').concat(t, ' ends'));
  }
    ...
    replace: function (t) {
      ...
      a.parentNode &&
        ...
        null === a.getAttribute(A) && X.keepOriginalSource
          ? ((t = h.createComment(((t = ' '.concat((t = a).outerHTML, ' ')), (t = ''.concat(t, 'Font Awesome fontawesome.com '))))),
        ...
        la ||
          ...
          Q(t).forEach(function (t) {
            ...
            'childList' === t.type &&
              ...
              'attributes' === t.type && t.target.parentNode && X.searchPseudoElements && s(t.target.parentNode),
              'attributes' === t.type &&
                ia(t.target) &&
                ~H.indexOf(t.attributeName) &&
                ('class' === t.attributeName &&
                ((e = t.target), (n = e.getAttribute ? e.getAttribute(C) : null), (e = e.getAttribute ? e.getAttribute(P) : null), n && e)
                  ? ((e = (a = Lt(Z(t.target))).prefix),
                    (a = a.iconName),
                    t.target.setAttribute(C, e || i),
                    a && t.target.setAttribute(P, a))
                  : (a = t.target) && a.classList && a.classList.contains && a.classList.contains(X.replacementClass) && o(t.target));
          }));
      })),
  ...
  function va(t) {
    ...
    return (
      ...
      (i.iconName && i.prefix) ||
        (i.prefix && 0 < n.length && (i.iconName = ((e = i.prefix), (n = t.innerText), (xt[e] || {})[n] || zt(i.prefix, bt(t.innerText))))),
      i
    );
  }
  function pa(t, a) {
    ...
    if (t) {
      ...
      return Xt(k({ type: 'icon' }, t), function () {
        return (
          ...
          qt({
            icons: { main: Kt(b), mask: r ? Kt(r.icon) : { found: !1, width: null, height: null, icon: {} } },
            prefix: m,
            iconName: d,
            transform: k(k({}, G), n),
            symbol: i,
        ...
        (t.i2svg = function (t) {
          ...
          (t.generateSvgReplacementMutation = function (n, t) {
            ...
            return new Promise(function (e, t) {
              Promise.all([
                Qt(i, s),
                a.iconName ? Qt(a.iconName, a.prefix) : Promise.resolve({ found: !1, width: 512, height: 512, icon: {} }),
              ])
                .then(function (t) {
                  var a = m(t, 2),
                    t = a[0],
          ...
          (t.generateAbstractIcon = function (t) {
            ...
            return (
              ...
              at(r) &&
                (a = Ht('generateAbstractTransformGrouping', { main: i, transform: r, containerWidth: i.width, iconWidth: i.width })),
              e.push(a || i.icon),
          ...
          layer: function (t) {
            ...
            return Xt({ type: 'layer' }, function () {
              ...
              return (
                ...
                [{ tag: 'span', attributes: { class: [''.concat(X.familyPrefix, '-layers')].concat(l(n)).join(' ') }, children: a }]
              );
            });
          },
        };
            ...
            return Xt({ type: 'counter', content: i }, function () {
              return (
                ...
                (t = {
                  content: i.toString(),
                  title: o,
                  extra: { attributes: c, styles: f, classes: [''.concat(X.familyPrefix, '-layers-counter')].concat(l(s)) },
                }),
                (a = t.content),
                (e = t.title),
                (n = t.extra),
            ...
            return Xt({ type: 'text', content: t }, function () {
              return (
                ...
                Vt({
                  ...
                  transform: k(k({}, G), n),
                  title: i,
                  extra: { attributes: o, styles: s, classes: [''.concat(X.familyPrefix, '-layers-text')].concat(l(r)) },
                })
              );
            });
          },
      ...
      provides: function (t) {
        t.generateLayersText = function (t, a) {
          var e,
            ...
            s = null;
          return (
            y && ((e = parseInt(getComputedStyle(t).fontSize, 10)), (o = (a = t.getBoundingClientRect()).width / e), (s = a.height / e)),
            X.autoA11y && !n && (r.attributes['aria-hidden'] = 'true'),
            Promise.resolve([t, Vt({ content: t.innerHTML, width: o, height: s, transform: i, title: n, extra: r, watchable: !0 })])
          );
        };
      },
    },
    ...
    return new Promise(function (e, t) {
      ...
      u && 'none' !== d && '' !== d
        ? ((s = l.getPropertyValue('content')),
          (n = ~['Solid', 'Regular', 'Light', 'Thin', 'Duotone', 'Brands', 'Kit'].indexOf(u[2]) ? I[u[2].toLowerCase()] : F[m]),
          (a = (d =
            ((d = (a = s).replace(xa, '')),
            (l = 0),
            (s = (m = d).length),
            (c =
              55296 <= (a = m.charCodeAt(l)) && a <= 56319 && l + 1 < s && 56320 <= (c = m.charCodeAt(l + 1)) && c <= 57343
                ? 1024 * (a - 55296) + c - 56320 + 65536
                : a),
            (a = Aa[0] <= c && c <= Aa[1]),
            { value: bt((c = 2 === d.length && d[0] === d[1]) ? d[0] : d), isSecondary: a || c })).value),
          (c = d.isSecondary),
          ...
          d &&
            ((a = Ot[(d = a)]),
            (d = zt('fas', d)),
            (d = a || (d ? { prefix: 'fas', iconName: d } : null) || { prefix: null, iconName: null }).iconName &&
              d.prefix &&
          ...
          !u || c || (f && f.getAttribute(C) === n && f.getAttribute(P) === i)
            ...
            : (b.setAttribute(p, i),
              ...
              Qt(u, n)
                .then(function (t) {
                  var a = qt(k(k({}, r), {}, { icons: { main: t, mask: Mt() }, prefix: n, iconName: i, extra: o, watchable: !0 })),
              ...
              children: [
                {
                  ...
                  children: [{ tag: a.icon.tag, children: a.icon.children, attributes: k(k({}, a.icon.attributes), i.path) }],
                },
              ],
            };
          };
        ...
        provides: function (t) {
          t.generateAbstractMask = function (t) {
            var a = t.children,
              ...
              o = {
                tag: 'mask',
                attributes: k(k({}, Ea), {}, { id: f, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }),
                children: [i, o],
              },
              o = {
                tag: 'defs',
                children: [{ tag: 'clipPath', attributes: { id: r }, children: 'g' === (t = t).tag ? t.children : [t] }, o],
              };
            return (
              a.push(o, {
                tag: 'rect',
                attributes: k({ fill: 'currentColor', 'clip-path': 'url(#'.concat(r, ')'), mask: 'url(#'.concat(f, ')') }, Ea),
              }),
          ...
          g.matchMedia && (r = g.matchMedia('(prefers-reduced-motion: reduce)').matches),
            (t.missingIconAbstract = function () {
              ...
              return (
                r ||
                  i.children.push(
                    { tag: 'animate', attributes: k(k({}, e), {}, { attributeName: 'r', values: '28;14;28;28;14;28;' }) },
