...
import { PrestationModel } from '../../entities/prestation.model';
import { ParametresFacture } from '../../entities/ParametresFacture';
...
export class ManagementAppComponent implements OnInit, OnDestroy {
  ...
  private getParametresFacture(): ParametresFacture {
